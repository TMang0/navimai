...
const AudioControl = () => {
  ...
  useEffect(() => {
    ...
    const playAudio = async () => {
      try {
        ...
        // Si falla, esperar el primer click
  ...
  return (
    <>
      ...
      >
        <img 
          src={isMuted ? '/images/volume-mute.png' : '/images/medium-volume.png'} 
...
const GiftBoxModel = ({ 
  ...
  const fbx = useLoader(FBXLoader, '/models/gift_box_V03.fbx');
  ...
  const [diffuseMap, metalnessMap, roughnessMap] = useLoader(
    THREE.TextureLoader,
    [
      '/models/gift_box_diffuse.png',
      '/models/gift_box_metal.png',
      '/models/gift_box_roughress.png'
    ]
  );
